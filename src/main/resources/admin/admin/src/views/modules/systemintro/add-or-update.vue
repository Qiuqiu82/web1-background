	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="副标�? prop="subtitle">
					<el-input v-model="ruleForm.subtitle" placeholder="副标�? clearable  :readonly="ro.subtitle"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="副标�? prop="subtitle">
					<el-input v-model="ruleForm.subtitle" placeholder="副标�? readonly></el-input>
				</el-form-item>
