    ...
    <div v-if="!showFlag" style="width: 100%;">
      <div>
        <el-table
          ...
          style="width: 100%;"
        >
          <el-table-column :resizable='true' :sortable='false' prop="ask" :formatter="askFormat" header-align="center" align="center" sortable label="新消�?></el-table-column>
          <el-table-column
          ...
          >
            <template slot-scope="scope">
              <el-tag v-if="scope.row.isreply==1" type="success">未回�?/el-tag>
              <el-tag v-if="scope.row.isreply==0" type="info">已回�?/el-tag>
            </template>
          </el-table-column>
          <el-table-column
            header-align="center"
          ...
          >
            <template slot-scope="scope">
              <el-button
                type="text"
				:style='{"border":"1px solid rgba(135, 154, 108, 1)","cursor":"pointer","padding":"0 24px","margin":"0 10px 5px 0","outline":"none","color":"rgba(135, 154, 108, 1)","borderRadius":"4px","background":"#fff","width":"auto","fontSize":"14px","height":"32px"}'
                size="small"
