<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="面料类别" prop="mianliaoleibie">
					<el-input v-model="ruleForm.mianliaoleibie" placeholder="面料类别" clearable  :readonly="ro.mianliaoleibie"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="面料类别" prop="mianliaoleibie">
					<el-input v-model="ruleForm.mianliaoleibie" placeholder="面料类别" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="面料价格" prop="mianliaojiage">
					<el-input v-model="ruleForm.mianliaojiage" placeholder="面料价格" clearable  :readonly="ro.mianliaojiage"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="面料价格" prop="mianliaojiage">
					<el-input v-model="ruleForm.mianliaojiage" placeholder="面料价格" readonly></el-input>
				</el-form-item>
			</template>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `mianliaoleibie/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.mianliaoleibieCrossAddOrUpdateFlag = false;
						 this.parent.search();
