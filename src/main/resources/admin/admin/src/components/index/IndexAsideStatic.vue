<template>
	<div class="menu-preview">
		...
		<el-scrollbar wrap-class="scrollbar-wrapper">
			<el-menu :default-openeds="[]" :unique-opened="true" :style='{"border":0,"padding":"0","listStyle":"none","margin":"60px 5px 15px","overflow":"hidden","background":"#FFF","position":"relative"}' class="el-menu-vertical-demo" default-active="0">
	...
	.menu-preview {
	  .el-scrollbar {
		...
		.el-menu-vertical-demo .el-submenu ::v-deep .el-menu .el-menu-item:hover {
						padding: 0 40px;
						color: #333;
						background: rgba(27, 167, 166, 0.5);
						line-height: 50px;
						height: 50px;
					}
